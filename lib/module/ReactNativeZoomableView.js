...
const ReactNativeZoomableView = (props, ref) => {
  ...
  const lastGestureCenterPosition = useRef();
  ...
  const debouncedOnStaticPinPositionChange = useDebounceCallback(position => props.onStaticPinPositionChange?.(position), 100);
  /**
