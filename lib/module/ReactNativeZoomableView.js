...
class ReactNativeZoomableView extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (originalMeasurementsChanged) {
      var _this$props$onLayoutM, _this$props14;

      (_this$props$onLayoutM = (_this$props14 = this.props).onLayoutMeasured) === null || _this$props$onLayoutM === void 0 ? void 0 : _this$props$onLayoutM.call(_this$props14, {
