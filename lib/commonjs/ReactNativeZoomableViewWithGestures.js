...
class ReactNativeZoomableViewWithGestures extends _react.default.Component {
  constructor(props) {
    super(props);

    _defineProperty(this, "zoomableViewRef", void 0);

    _defineProperty(this, "_onShiftingEnd", (e, gestureState, zoomableViewState) => {
    ...
    this.zoomableViewRef = /*#__PURE__*/_react.default.createRef();
  }
  ...
  _validateSwipe(gestureState) {
    ...
    return onSwipeUp && swipeDirection === SWIPE_UP || onSwipeDown && swipeDirection === SWIPE_DOWN || onSwipeLeft && swipeDirection === SWIPE_LEFT || onSwipeRight && swipeDirection === SWIPE_RIGHT;
  }
  /**
  ...
  _triggerSwipeHandlers(swipeDirection, gestureState) {
    ...
    const {
      ...
      SWIPE_UP,
      SWIPE_DOWN
    } = swipeDirections; // trigger the general onswipe callback
  ...
  render() {
    return /*#__PURE__*/_react.default.createElement(_ReactNativeZoomableView.default, _extends({}, this.props, {
...
var _default = ReactNativeZoomableViewWithGestures;
