...
class ReactNativeZoomableView extends _react.Component {
  ...
  constructor(props) {
    ...
    _defineProperty(this, "_updateStaticPin", () => {
      ...
      if (!position) return;
      (_this$props$onStaticP = (_this$props7 = this.props).onStaticPinPositionChange) === null || _this$props$onStaticP === void 0 ? void 0 : _this$props$onStaticP.call(_this$props7, position);
    });
    ...
    this.gestureHandlers = _reactNative.PanResponder.create({
      ...
      onStartShouldSetPanResponderCapture: (evt, gestureState) => {
        var _this$props$onStartSh, _this$props11;

        return !!((_this$props$onStartSh = (_this$props11 = this.props).onStartShouldSetPanResponderCapture) !== null && _this$props$onStartSh !== void 0 && _this$props$onStartSh.call(_this$props11, evt, gestureState));
      },
      onMoveShouldSetPanResponderCapture: (evt, gestureState) => {
        var _this$props$onMoveSho, _this$props12;

        return !!((_this$props$onMoveSho = (_this$props12 = this.props).onMoveShouldSetPanResponderCapture) !== null && _this$props$onMoveSho !== void 0 && _this$props$onMoveSho.call(_this$props12, evt, gestureState));
      }
    });
   ...
   */
  _invokeOnTransform() {
    var _this$props$onTransfo, _this$props13;
    ...
    (_this$props$onTransfo = (_this$props13 = this.props).onTransform) === null || _this$props$onTransfo === void 0 ? void 0 : _this$props$onTransfo.call(_this$props13, zoomableViewEvent);

    if (position) {
      var _this$props$onStaticP2, _this$props14, _this$debouncedOnStat;

      (_this$props$onStaticP2 = (_this$props14 = this.props).onStaticPinPositionMove) === null || _this$props$onStaticP2 === void 0 ? void 0 : _this$props$onStaticP2.call(_this$props14, position);
      (_this$debouncedOnStat = this.debouncedOnStaticPinPositionChange) === null || _this$debouncedOnStat === void 0 ? void 0 : _this$debouncedOnStat.call(this, position);
    }
  ...
  _handlePinching(e, gestureState) {
    var _this$props$onZoomAft, _this$props15;
    ...
    this.zoomAnim.setValue(this.zoomLevel);
    (_this$props$onZoomAft = (_this$props15 = this.props).onZoomAfter) === null || _this$props$onZoomAft === void 0 ? void 0 : _this$props$onZoomAft.call(_this$props15, e, gestureState, this._getZoomableViewEventObject());
  }
  /**
  ...
  _handleDoubleTap(e) {
    ...
    if (!originalPageX || !originalPageY) return; // define new zoom position coordinates
  ...
  async _zoomToLocation(x, y, newZoomLevel) {
    var _this$props$onZoomBef, _this$props16, _this$props$onZoomAft2, _this$props17;

    if (!this.props.zoomEnabled) return;
    if (this.state.originalWidth == null) return;
    if (this.state.originalHeight == null) return;
    (_this$props$onZoomBef = (_this$props16 = this.props).onZoomBefore) === null || _this$props$onZoomBef === void 0 ? void 0 : _this$props$onZoomBef.call(_this$props16, null, null, this._getZoomableViewEventObject()); // == Perform Zoom Animation ==
    ...
    (_this$props$onZoomAft2 = (_this$props17 = this.props).onZoomAfter) === null || _this$props$onZoomAft2 === void 0 ? void 0 : _this$props$onZoomAft2.call(_this$props17, null, null, this._getZoomableViewEventObject());
  }
  /**
  ...
  async zoomTo(newZoomLevel) {
    ...
    this.props.maxZoom && newZoomLevel > this.props.maxZoom || this.props.minZoom && newZoomLevel < this.props.minZoom) return false;
