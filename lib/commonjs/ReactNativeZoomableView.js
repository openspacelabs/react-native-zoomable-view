...
class ReactNativeZoomableView extends _react.Component {
   ...
   */
  _invokeOnTransform() {
    var _this$props$onTransfo, _this$props12, _this$props$onStaticP3, _this$props13;
    ...
    (_this$props$onTransfo = (_this$props12 = this.props).onTransform) === null || _this$props$onTransfo === void 0 ? void 0 : _this$props$onTransfo.call(_this$props12, zoomableViewEvent);
    (_this$props$onStaticP3 = (_this$props13 = this.props).onStaticPinPositionMove) === null || _this$props$onStaticP3 === void 0 ? void 0 : _this$props$onStaticP3.call(_this$props13, this._staticPinPosition());
  ...
  _handlePinching(e, gestureState) {
    var _this$props$onZoomAft, _this$props14;
    ...
    this.zoomAnim.setValue(this.zoomLevel);
    (_this$props$onZoomAft = (_this$props14 = this.props).onZoomAfter) === null || _this$props$onZoomAft === void 0 ? void 0 : _this$props$onZoomAft.call(_this$props14, e, gestureState, this._getZoomableViewEventObject());
  }
  /**
  ...
  async _zoomToLocation(x, y, newZoomLevel) {
    var _this$props$onZoomBef, _this$props15, _this$props$onZoomAft2, _this$props16;

    if (!this.props.zoomEnabled) return;
    (_this$props$onZoomBef = (_this$props15 = this.props).onZoomBefore) === null || _this$props$onZoomBef === void 0 ? void 0 : _this$props$onZoomBef.call(_this$props15, null, null, this._getZoomableViewEventObject()); // == Perform Zoom Animation ==
    ...
    (_this$props$onZoomAft2 = (_this$props16 = this.props).onZoomAfter) === null || _this$props$onZoomAft2 === void 0 ? void 0 : _this$props$onZoomAft2.call(_this$props16, null, null, this._getZoomableViewEventObject());
  }
  /**
