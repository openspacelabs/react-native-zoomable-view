...
exports.default = exports.ReactNativeZoomableViewContext = exports.ReactNativeZoomableView = exports.ConstantSizeMarker = void 0;
...
const ConstantSizeMarker = ({
  left,
  top,
  children
}) => {
  const context = _react.default.useContext(ReactNativeZoomableViewContext);
...
exports.ConstantSizeMarker = ConstantSizeMarker;
