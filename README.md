...
| onLayout          | Like `View`'s `onLayout`, but different in that it syncs with this component's internal state and returns the measurements directly without a sythentic event | { width, height, x, y }                      | void                                                                                       |
